...
export class SaucesService {
  ...
  getSauces() {
    this.http
      .get<Sauce[]>("https://piiquante-backend-wjow.onrender.com//api/sauces")
      .pipe(
  ...
  getSauceById(id: string) {
    return this.http
      .get<Sauce>(
        "https://piiquante-backend-wjow.onrender.com/api/sauces/" + id
      )
  ...
  likeSauce(id: string, like: boolean) {
    return this.http
      .post<{ message: string }>(
        "https://piiquante-backend-wjow.onrender.com/api/sauces/" +
          id +
          "/like",
